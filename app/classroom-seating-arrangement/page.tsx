    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-cyan-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
      ...
      <main className="mx-auto max-w-5xl px-6 py-16">
        ...
        <section className="mt-20">
          <h2 className="text-center text-2xl font-bold text-emerald-950 dark:text-emerald-50">Choose Your Layout</h2>
            ...
            {arrangements.map((a) => (
              <div key={a.title} className="rounded-xl border border-zinc-200 p-6 dark:border-zinc-800">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  <h3 className="text-xl font-semibold text-emerald-950 dark:text-emerald-50">{a.title}</h3>
                  <span className="mt-1 text-sm text-emerald-600 dark:text-emerald-400 sm:mt-0">Best for: {a.bestFor}</span>
                </div>
                <p className="mt-3 text-slate-700 dark:text-slate-300">{a.desc}</p>
        ...
        <section className="mt-20">
          <h2 className="text-center text-2xl font-bold text-emerald-950 dark:text-emerald-50">How to Choose the Right Arrangement</h2>
          <div className="mx-auto mt-8 max-w-3xl space-y-6 text-slate-700 dark:text-slate-300">
            ...
            <p>
              ...
              <Link href="/seating-chart-templates" className="text-emerald-600 hover:text-blue-700 dark:text-emerald-400 dark:hover:text-blue-300 underline">seating chart templates</Link>{" "}
        ...
        <section className="mt-20">
          <h2 className="text-center text-2xl font-bold text-emerald-950 dark:text-emerald-50">Tips for Better Seating Arrangements</h2>
          <div className="mt-8 grid gap-6 sm:grid-cols-2 max-w-3xl mx-auto">
            {[
              ...
              <div key={tip.title} className="rounded-xl border border-zinc-200 p-6 dark:border-zinc-800">
                <h3 className="font-semibold text-emerald-950 dark:text-emerald-50">{tip.title}</h3>
                <p className="mt-2 text-sm text-slate-700 dark:text-slate-300">{tip.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-20">
          <h2 className="text-center text-2xl font-bold text-emerald-950 dark:text-emerald-50">All Layouts with Pro</h2>
          ...
          <div className="mt-6 text-center">
            <Link href="/#pricing" className="text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 text-sm font-medium">
              See pricing &rarr;
            </Link>
          </div>
        </section>
        ...
        <section className="mt-20">
          ...
          <div className="mt-8 max-w-3xl mx-auto space-y-6">
            {[
              ...
              <details key={item.q} className="group rounded-xl border border-emerald-200/50 dark:border-emerald-900/30 bg-white dark:bg-slate-800 hover:border-emerald-400/50 dark:hover:border-emerald-700/50 shadow-sm hover:shadow-lg transition">
                <summary className="cursor-pointer px-6 py-4 font-medium text-emerald-950 dark:text-emerald-50">
                  {item.q}
                </summary>
                <p className="px-6 pb-4 text-sm text-slate-700 dark:text-slate-300">{item.a}</p>
              </details>
            ))}
          </div>
        </section>
        ...
        <section className="mt-20 rounded-3xl border-2 border-emerald-500 bg-gradient-to-br from-emerald-50 to-cyan-50 dark:from-emerald-900/20 dark:to-cyan-900/20 p-12 text-center">
          <h2 className="text-2xl font-bold text-emerald-950 dark:text-emerald-50">Build your classroom arrangement</h2>
          <p className="mt-2 text-slate-700 dark:text-slate-300">Pick a layout, add your students, and arrange desks with drag-and-drop. Free, no signup.</p>
